...
void kernel_main()
{
    ...
    // explicitly in host code. This is uaully a good idea as it makes coding
    ...
    for(uint32_t i = 0; i < n_tiles; i++) {
        ...
        cb_reserve_back(cb_in2, 1); // other kernels cannot consume the tiles fast enough.
        ...
        noc_async_read_tile(i, c, cb_in2_addr); // to reduce the data movement overhead.
        ...
        cb_push_back(cb_in2, 1); // calling `cb_wait_front` will see this tile
    }
}
